...
# print(gradientError(petalData, oldWeight, patterns))
...
# nextWeight(1,0.5,totSquareError(petalData, [-3.9, 0.46, 0.95], patterns),gradientError(petalData, [-3.9, 0.46, 0.95], patterns),[-3.9, 0.46, 0.95], petalData, patterns)
...
def gradientDescent(initialWeight, petalData, patterns):
	...
	return finalWeight, currentError
print(gradientDescent([-1, 0.7, 2], petalData, patterns))
################################################################
#3b)
#define an initial weight
# initialWeight = np.array([1, 1, 1])
